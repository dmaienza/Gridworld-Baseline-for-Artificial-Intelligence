...
def draw_base(goal):
    ...
    # draw the obstacles
    pygame.draw.rect(screen, border_color, pygame.Rect((border, 2 * border), (4 * border + 1, border + 1)))
    pygame.draw.rect(screen, border_color, pygame.Rect((6 * border, 2 * border), (2 * border + 1, border + 1)))
    pygame.draw.rect(screen, border_color, pygame.Rect((2 * border, 4 * border), (6 * border + 1, border + 1)))
    pygame.draw.rect(screen, border_color, pygame.Rect((5 * border, 5 * border), (border, border)))
    pygame.draw.rect(screen, border_color, pygame.Rect((5 * border, 7 * border), (border, border + 1)))
